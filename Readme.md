...
# Parsing Script – SENSO8 NB-IoT IAQ - Rev. B

This **Parsing** script is designed for the **SENSO8 NB-IoT IAQ** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – SENSO8 NB-IoT IAQ Rev. B

Este script de **Parsing** está diseñado para el modelo **SENSO8 NB-IoT IAQ** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
